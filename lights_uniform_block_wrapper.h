...
public:
	...
	bool addLight(glm::vec3 pos, bool mode, glm::vec3 colour = glm::vec3(1.f), glm::vec3 attenuation = glm::vec3(1.f,0.f,0.f)); // for point lights
	bool addLight(glm::vec3 pos, bool mode, glm::mat4 lightSpace, glm::vec3 colour = glm::vec3(1.f), glm::vec3 attenuation = glm::vec3(1.f,0.f,0.f)); // for directional lights which require the light space matrix to be sent to the shaders
